...
public class MPConfig {
    ...
    public static SqlSession before() throws IOException {
...
//        configuration.setLogImpl(Slf4jImpl.class);
        //扫描mapper接口所在包
        configuration.addMappers("pers.ailurus.mapper");
    ...
    private static DataSource initDataSource() {
        ...
        dataSource.setJdbcUrl("jdbc:mysql://localhost:3306/java_analysis?allowPublicKeyRetrieval=true&characterEncoding=utf-8&useSSL=false&serverTimezone=GMT%2B8&useUnicode=true");
